...
`spec-check`, `spec-doctor`, `spec-explain`, `spec-feature`, `spec-fix`, `spec-hooks`, `spec-implement`, `spec-init`, `spec-migrate`, `spec-plan`, `spec-play-coverage`, `spec-preflight`, `spec-propose`, `spec-refine`, `spec-refresh-conventions`, `spec-refresh-from-brainstorm`, `spec-ship`, `spec-specify`, `spec-stack`, `spec-status`, `spec-test`, `spec-verify-output`.
