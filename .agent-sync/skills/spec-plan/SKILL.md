...
5. Émettre la commande slash `/goal` avec hash et références machine :
   ```
   /goal hash:<hash> | spec-plan for <feature> — contract-file:$TMPDIR/livespec-goals/goal-spec-plan-<hash8>.contract.json — state-file:$TMPDIR/livespec-goals/goal-spec-plan-<hash8>.state.json — mode:enforced
   ```
