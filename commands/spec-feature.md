...
This convention is mirrored by `agents/livespec-documenter.md § Step 5` and `commands/spec-implement.md § Phase 4` (execution log path), and by `commands/spec-specify.md § Step 2` (NNN allocation site).
...
> **Economy mode (`--economy`):** execute `commands/spec-specify.md` steps inline in the main context instead of spawning an agent.
...
> **Economy mode (`--economy`):** execute `commands/spec-plan.md` steps inline in the main context instead of spawning an agent.
...
> **Economy mode (`--economy`):** execute `commands/spec-implement.md` steps inline in the main context instead of spawning an agent.
...
> RunArtifact schema and `commands/spec-feature.expectations.md` for the contract.
