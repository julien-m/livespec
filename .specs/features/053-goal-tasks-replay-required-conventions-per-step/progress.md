...
- [x] Step 1: Add failing contract tests for task-level convention payload
- [x] Step 2: Add failing proof validation tests for missing convention evidence
- [x] Step 3: Attach required conventions to rendered goal tasks
