...
title: 'Implementation Map: Visual Testing Governance'
type: implementation
updated: 2026-04-14
---
...
|---|---|---|---|---|
| [FR-001: Write baseline.manifest.yml after approval](spec.md#fr-001) | `.agent-sync/skills/spec-test/SKILL.md` (Phase 4.5.3 Step D) | `system/schemas/baseline-manifest.md` | ✅ Implemented | 2026-04-14 |
| [FR-002: --show-provenance flag](spec.md#fr-002) | `.claude/.agent-sync/skills/spec.check.md` (Step 3.1) | `<!-- @spec FR-002: show-provenance flag reads and displays manifest -->` | ✅ Implemented | 2026-04-14 |
...
| [FR-005: Browser version detection](spec.md#fr-005) | `.claude/.agent-sync/skills/spec.check.md` (Step 8.0 — playwright --version) | same anchor as FR-003 | ✅ Implemented | 2026-04-14 |
| [FR-006: --visual-status governance dashboard](spec.md#fr-006) | `.claude/.agent-sync/skills/spec.check.md` (Step 8.5) | `<!-- @spec FR-006: visual-status flag scans all features and classifies baselines -->` | ✅ Implemented | 2026-04-14 |
...
|---|---|---|---|
| AC-001 | spec.test writes a baseline manifest after every baseline approval | `.agent-sync/skills/spec-test/SKILL.md` Phase 4.5.3 Step D + DoD checklist | ✅ Implemented |
...
| `.claude/.agent-sync/skills/spec.test.md` | Modified | Phase 4.5.3 Step D: manifest write after approval; DoD checklist updated |
| `.claude/.agent-sync/skills/spec.check.md` | Modified | Step 3.1: --show-provenance; Step 8.0: Staleness Gate (mockup hash + browser version); Step 8.5: --visual-status governance dashboard; Flags table updated; Overview updated |
...
| Requirement | File(s) | @spec Anchor | Status | Last Verified |
|---|---|---|---|---|
| FR-001 | `.specs/features/004-visual-testing-governance/implementation.md` | @spec(FR-001) | ✅ Implemented | 2026-06-08 |
| FR-002 | `.specs/features/004-visual-testing-governance/implementation.md` | @spec(FR-002) | ✅ Implemented | 2026-06-08 |
| FR-003 | `.specs/features/004-visual-testing-governance/implementation.md` | @spec(FR-003) | ✅ Implemented | 2026-06-08 |
| FR-004 | `.specs/features/004-visual-testing-governance/implementation.md` | @spec(FR-004) | ✅ Implemented | 2026-06-08 |
| FR-005 | `.specs/features/004-visual-testing-governance/implementation.md` | @spec(FR-005) | ✅ Implemented | 2026-06-08 |
| FR-006 | `.specs/features/004-visual-testing-governance/implementation.md` | @spec(FR-006) | ✅ Implemented | 2026-06-08 |
| FR-007 | `.specs/features/004-visual-testing-governance/implementation.md` | @spec(FR-007) | ✅ Implemented | 2026-06-08 |
| FR-008 | `.specs/features/004-visual-testing-governance/implementation.md` | @spec(FR-008) | ✅ Implemented | 2026-06-08 |
