...
|---|---|---|---|---|
| [FR-001: Mandatory Phase 6.5 gate](spec.md#fr-001) | `commands/implement.md` | `@spec FR-001: Mandatory visual gate — .specs/features/046-visual-implementation-gate/spec.md#fr-001` | ✅ Implemented | 2026-05-17 |
| [FR-002: Tooling blocks UI features](spec.md#fr-002) | `commands/implement.md` | `@spec FR-002: Tooling blocks UI — .specs/features/046-visual-implementation-gate/spec.md#fr-002` | ✅ Implemented | 2026-05-17 |
| [FR-003: no-visual caps status](spec.md#fr-003) | `commands/implement.md` | `@spec FR-003: no-visual caps status — .specs/features/046-visual-implementation-gate/spec.md#fr-003` | ✅ Implemented | 2026-05-17 |
| [FR-004: Visual gate verdict](spec.md#fr-004) | `commands/test.md` | `@spec FR-004: Visual gate verdict — .specs/features/046-visual-implementation-gate/spec.md#fr-004` | ✅ Implemented | 2026-05-17 |
| [FR-005: Expectations updated](spec.md#fr-005) | `commands/implement.expectations.md`, `commands/test.expectations.md` | Covered by command expectation contract text | ✅ Implemented | 2026-05-17 |
...
| `commands/implement.md` | Adds Phase 6.5 and stricter visual completion rules. |
| `commands/test.md` | Adds structured visual gate verdict. |
| `commands/implement.expectations.md` | Aligns implement contract with visual gate behavior. |
| `commands/test.expectations.md` | Aligns test contract with visual gate verdict. |
