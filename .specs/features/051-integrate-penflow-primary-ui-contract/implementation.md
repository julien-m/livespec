...
| FR-002 | `validator/cli_commands/penflow_contract_cmd.py`, `validator/cli_commands/__init__.py` | CLI module doc | ✅ Implemented | 2026-05-21 |
| FR-003 | `.agent-sync/skills/spec-init/SKILL.md` | Step 3.5.5 | ✅ Implemented | 2026-05-21 |
