...
| `commands/feature.md` | Modified | Calls `resolve_feature_slug` before pipeline-init and dispatch |
| `commands/implement.md` | Modified | Phase 0.5 → Phase 1 handoff explicit; single `progress.md` creation site |
...
| @spec FR-002 | `spec.md#fr-002` | `validator/identity.py:27` — canonical slug regex; `commands/feature.md:64` — pre-side-effect resolution call |
| @spec FR-003 | `spec.md#fr-003` | `system/state-machine.md`; `commands/feature.md:593` — state machine reference |
| @spec FR-004 | `spec.md#fr-004` | `agents/livespec-supervisor.md:154` — hard halt on `Blocked`; `commands/feature.md:594` |
...
| @spec FR-007 | `spec.md#fr-007` | `agents/livespec-documenter.md:92`; `commands/implement.md:329` — canonical log path |
| @spec FR-008 | `spec.md#fr-008` | `commands/implement.md:154,212` — phase ordering + single `progress.md` creation site |
| @spec FR-009 | `spec.md#fr-009` | `validator/identity.py:156` — placeholder literal rejection; `commands/feature.md:65` |
...
| AC-008 | Covered | `agents/livespec-documenter.md:92`; `commands/implement.md:329` |
| AC-009 | Covered | `commands/implement.md:154,212` (Phase 0.5 → Phase 1 handoff) |
