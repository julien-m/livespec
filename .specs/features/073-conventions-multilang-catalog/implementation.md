...
**Status:** Implemented (P0/P1 AST slice + exhaustive AI-res/ARS manifest + 564 executable ARS line rules connected to the runtime).
...
| FR-008, FR-009, AC-011, AC-012 | [corpus.py](../../../validator/conventions_ast/corpus.py), [source_decisions.py](../../../validator/conventions_ast/source_decisions.py), [source_decision_builders.py](../../../validator/conventions_ast/source_decision_builders.py), [source_decision_ars.py](../../../validator/conventions_ast/source_decision_ars.py), [ars_rules.py](../../../validator/conventions_ast/ars_rules.py), [ars_executable_rules.csv](../../../validator/conventions_ast/rule_catalog/ars_executable_rules.csv), [source_decision_paths.py](../../../validator/conventions_ast/source_decision_paths.py), [source_decision_types.py](../../../validator/conventions_ast/source_decision_types.py), [source_decision_validation.py](../../../validator/conventions_ast/source_decision_validation.py), [source_family_checks.py](../../../validator/conventions_ast/source_family_checks.py), [taxonomy.py](../../../validator/conventions_ast/taxonomy.py), [conventions_feature_scope.py](../../../validator/conventions_feature_scope.py), [conventions_cmd.py](../../../validator/cli_commands/conventions_cmd.py), [conventions_gate.py](../../../validator/conventions_gate.py), [conventions_receipt.py](../../../validator/conventions_receipt.py) | @spec FR-008, FR-009 | ✅ | 2026-06-30 |
...
| AC-011 | [test_conventions_taxonomy.py](../../../tests/test_conventions_taxonomy.py), [test_conventions_source_decisions.py](../../../tests/test_conventions_source_decisions.py), [test_conventions_source_family_checks.py](../../../tests/test_conventions_source_family_checks.py), [test_conventions_ars_rules.py](../../../tests/test_conventions_ars_rules.py) | ✅ |
| AC-012 | [test_conventions_taxonomy.py](../../../tests/test_conventions_taxonomy.py), [test_conventions_source_decisions.py](../../../tests/test_conventions_source_decisions.py), [test_conventions_source_family_checks.py](../../../tests/test_conventions_source_family_checks.py), [test_conventions_ars_rules.py](../../../tests/test_conventions_ars_rules.py) | ✅ |

## Files Created/Modified

**Created:** `validator/conventions_lang/rust_adapter.py`, `validator/conventions_lang/kotlin_adapter.py`, `validator/conventions_ast/taxonomy.py`, `validator/conventions_ast/corpus.py`, `validator/conventions_ast/source_decisions.py`, `validator/conventions_ast/source_decision_builders.py`, `validator/conventions_ast/source_decision_ars.py`, `validator/conventions_ast/source_decision_paths.py`, `validator/conventions_ast/source_family_checks.py`, `validator/conventions_ast/ars_rules.py`, `validator/conventions_ast/rule_catalog/ars_executable_rules.csv`, `validator/conventions_ast/rule_catalog/{rust_high,swift_high,kotlin_high}.yaml`, fixtures under `tests/fixtures/conventions_ast/{ars_rules,generated,rust,swift,kotlin,ts/no_commonjs_require}/`, tests `test_conventions_lang_multilang.py`, `test_conventions_ast_multilang.py`, `test_conventions_taxonomy.py`, `test_conventions_source_decisions.py`, `test_conventions_generated_catalog.py`, `test_conventions_css_tailwind.py`, `test_conventions_sql.py`, `test_conventions_source_family_checks.py`, `test_conventions_ars_rules.py`.
...
- The ARS executable inventory is checked in at [ars_executable_rules.csv](../../../validator/conventions_ast/rule_catalog/ars_executable_rules.csv); each of its 564 CSV rows has a unique `ars.rule.NNNNN` runtime id, `ars-rule:ARS-RULE-NNNNN` backend id, detector id, execution wrapper path, callable wrapper object, PASS fixture, FAIL fixture, and pytest evidence.
- Language-specific ARS rows are reachable through `verify` source discovery: SQL, Go, Delphi, shell, JS module variants, Kotlin, CSS, TS, Rust, Python, and Swift suffixes are in [conventions_feature_scope.py](../../../validator/conventions_feature_scope.py).
- Real project ARS violations are blocking `error` findings; the scanner skips only ARS runtime/catalog self-definition files to avoid self-detecting its own regex and taxonomy literals.
- `ARS-RULE-02508` is individually implemented: destructive modal/dialog/sheet actions must expose an explicit destructive confirmation button, not generic `Confirm`, `OK`, or `Yes`.
- Generated-executable sources still use 15 deterministic checker families for source-level coverage outside the 564-row CSV inventory; the generic `source-decision-contract` backend is rejected by validation.
...
- Rule-level evidence on 2026-06-30: `rule_level_project_inventory_enabled=true`, `rule_level_inventory_total_count=564`, `rule_level_runtime_rule_count=564`, `rule_level_missing_count=0`; feature-scoped receipt PASS at [.specs/conventions/runs/worker-ars-564-rule-level/receipt.json](../../conventions/runs/worker-ars-564-rule-level/receipt.json).
