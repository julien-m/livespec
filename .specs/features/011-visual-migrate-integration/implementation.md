...
|---|---|---|---|---|
| [FR-001: Unconditional invocation](spec.md#fr-001) | commands/spec-migrate.md | `@spec FR-001: Unconditional invocation after migration — spec.md#fr-001` | ✅ Implemented | 2026-04-17 |
| [FR-002: Silent no-prompt](spec.md#fr-002) | commands/spec-migrate.md | `@spec FR-002: Silent no-prompt — spec.md#fr-002` | ✅ Implemented | 2026-04-17 |
...
| [FR-007: Post-migration summary](spec.md#fr-007) | commands/spec-migrate.md | `@spec FR-007: Post-migration visual summary — spec.md#fr-007` | ✅ Implemented | 2026-04-17 |
| [FR-008: Script-missing guard](spec.md#fr-008) | commands/spec-migrate.md | `@spec FR-008: Script-missing guard — spec.md#fr-008` | ✅ Implemented | 2026-04-17 |
| [FR-009: Node-missing guard](spec.md#fr-009) | commands/spec-migrate.md | `@spec FR-009: Node-missing guard — spec.md#fr-009` | ✅ Implemented | 2026-04-17 |
| [FR-010: Non-fatal on failure](spec.md#fr-010) | commands/spec-migrate.md | `@spec FR-010: Non-fatal on failure — spec.md#fr-010` | ✅ Implemented | 2026-04-17 |
...
| AC-011 | commands/spec-migrate.md Step 4.5 guard (command-layer spec) — no automated test; PATH manipulation deferred | Documented |
...
- `commands/spec-migrate.md` — Removed early exit on "already up to date", added Step 4.5 (Visual Test Scaffolding) with 3 guards, added visual summary to Report, added 3 edge cases
