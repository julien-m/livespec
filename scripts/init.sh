...
Commands: `/spec.init` · `/spec.propose` · `/spec.specify` · `/spec.plan` · `/spec.implement` · `/spec.check` · `/spec.explain` · `/spec.stack` · `/spec.feature` · `/spec.preflight` · `/spec.hooks` · `/spec.play-coverage` · `/spec.refine`
<!-- livespec:end -->'
